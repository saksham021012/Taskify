  ...
  return (
    <form 
      ...
      className={
        isEditing 
          ? "space-y-4" 
          : "bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mt-8"
      }
    >
      {formTitle && (
      ...
      <div className="space-y-4">
        ...
        <input 
          ...
          className={`
            ...
            ${isEditing ? 'px-3 py-2' : 'px-4 py-3 border-gray-200 rounded-lg'}
          `}
        ...
        <div className="flex gap-2">
          ...
          <button 
            ...
            className={`
              ...
              text-white transition-colors flex items-center gap-2 disabled:cursor-not-allowed
              ${isEditing 
          ...
          > 
            ...
            {isSubmitting ? (
              ...
              initialData ? <Save size={20} /> : <CirclePlus size={20} />
            )}
